...
public const string SHORTENER_URL = "https://jlik.me/";
...
public const string UTM_SOURCE="jeliknes";
...
public static async Task<HttpResponseMessage> Run(HttpRequestMessage req, NextId keyTable, CloudTable tableOut, TraceWriter log)
{
    ...
    if (tagMediums) 
    {
        ...
        {
            var mediumUrl = $"{url}&utm_medium={medium}&WT.mc_id=link-{medium}-{UTM_SOURCE}";
